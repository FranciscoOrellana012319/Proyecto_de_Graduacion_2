<?php 
	class vistasModelo{
		...
		protected static function obtener_vistas_modelo($vistas,$modulo,$idioma){
			$lista_blanca=["index","signin","product","home","registration","bag","details","profile","admin-new","admin-list","admin-search","admin-update","client-new","client-list","client-search","client-update","category-new","category-list","category-search","category-update","company","product-new","product-list","product-search","product-minimum","product-update","product-cover","product-gallery","product-info","order-list","order-search","ordered-product","order-update"];

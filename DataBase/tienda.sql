...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-09-2021 a las 02:17:20
...
(5, 'Cajas decoradas', 'cajas decoradas llena de muchas cosas', 'Habilitada'),
(7, 'Arreglo con golosinas', 'Arreglo con golosinas', 'Habilitada');
...
CREATE TABLE `pedidos` (
  `id` int(255) NOT NULL,
  `fecha` date NOT NULL,
  `productos` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `subtotal` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `total` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `envio` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `pago` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `id_cliente` varchar(255) COLLATE utf8_spanish_ci NOT NULL
...
--
ALTER TABLE `categoria`
  MODIFY `categoria_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

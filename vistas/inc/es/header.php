<header class="header full-box bg-white">
    <div class=" full-box">
        <a href="<?php echo SERVERURL; ?>index/">
            <img src="<?php echo SERVERURL; ?>vistas/assets/img/logo.png" alt="<?php echo COMPANY; ?>" class="img-fluid" style="height:60px; width:130px;">
        </a>
    </div>
    ...
    <div class="header-options full-box">
        ...
        <a href="<?php echo SERVERURL; ?>bag/" class="header-button full-box text-center" title="Carrito" >
            ...
            <span class="badge bg-primary rounded-pill bag-count" ><?php if(isset($_SESSION['bag'])){$count = 0;foreach ($_SESSION['bag'] as $cont) { if($cont['cantidad'] != 0){ $count++; }} echo $count;} else{echo "0";} ?></span>
        </a>

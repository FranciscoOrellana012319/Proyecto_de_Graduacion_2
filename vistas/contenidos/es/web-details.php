            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="hidden" name="producto" value="<?php echo $campos['producto_id']; ?>">
                                        <input type="text" value="1" class="form-control text-center" name="cantidad" id="product_cant" pattern="[1-9]{1,10}" maxlength="10" >
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="text" name="cantidad" value="1" class="form-control text-center" id="product_cant" pattern="[1-9]{1,10}" maxlength="10" >
                                        <label for="product_cant" class="form-label">Cantidad</label>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 text-center">
                ...
                <?php 
                    ...
                    if(isset($_POST['agregar'])){
                        echo $ins_carrito->agregar_carrito_controlador();
                    }

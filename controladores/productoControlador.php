<?php
	...
	class productoControlador extends mainModel{
        ...
        public function registrar_producto_controlador(){
            ...
            /*-- Verificando stock total y minimo --*/
            if($stock_total<=0){
                $alerta=[
					"Alerta"=>"simple",
					"Titulo"=>"Formato no valido",
        ...
        /*--------- Controlador paginador productos (administrador)---------*/
        ...
        /*--------- Controlador paginador productos (cliente) ---------*/
                            ...
                            <div class="card-product-body">
                                ...
                                <div class="text-center card-product-options" style="padding: 10px 0;">
                                    <form action=""  method="POST" style="float:left;">
                                        ...
                                        <input type="hidden" name="producto" value="'.$rows['producto_id'].'">
        ...
        /*--------- Controlador paginador productos (pedidos) ---------*/
        public function pedidos_paginador_producto_controlador($busqueda){
            ...
            foreach($busqueda as $row){
                $prdoducto = $row['producto'];
                $cantidad = $row['cantidad'];

			    $consulta="SELECT SQL_CALC_FOUND_ROWS * FROM producto WHERE producto_id = $prdoducto";
			    ...
			    foreach($datos as $rows){
			    	...
			    	$tabla.='
                        <div class="product-list mb-4">
                            ...
                            <div class="product-list-body">
                                <h5 class="mb-1 roboto-condensed-regular text-center">'.$rows['producto_nombre'].'</h5>
                                <div class="container-fluid" style="padding-top: 5px;">
                                    <div class="row">
                                        <div class="col-6 col-lg-4 mb-2">
                                            <strong class="text-uppercase"><i class="fas fa-barcode fa-fw"></i> Código:</strong> '.$rows['producto_codigo'].'
                                        ...
                                        <center>
                                        <div class="col-6 col-lg-4 mb-2">
                                            <h5 style="color:#FF0000;" ><strong class="text-uppercase"><i class="far fa-box fa-fw"></i> Cantidad del pedido: '.$cantidad.'</strong></h5>
                                        </div>
                                        </center>
                                    </div>
                                </div>
        ...
        /*---------- Controlador eliminar portada de producto  ----------*/
        ...
        /*---------- Controlador agregar galeria de producto  ----------*/
		public function agregar_galeria_producto_controlador(){
            ...
            /*-- Comprobando imagenes de galeria --*/
        ...
        /*---------- Controlador eliminar galeria de producto ----------*/
